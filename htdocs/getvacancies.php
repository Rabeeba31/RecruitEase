...
echo "<div class=\"table-responsive table-bordered\" >            
			...
			while($row = $result->fetch_assoc()){	   
				   ...
				   //$sql1="SELECT * FROM applications WHERE s_mail = '".$_SESSION['email']."' AND job_id=".$row['id']."";
				  ...
				  /* if($result1->num_rows != 0){
				    $row1 = $result1->fetch_assoc();
					   ...
					   echo" <td>
									...
									<input type=\"button\" value=\"Check eligiblity\" onclick=\"msg('".$row['id']."','".$_SESSION['email']."',this)\">
