		...
		<nav class="navbar navbar-fixed-top" id="top-nav">
			<div class="container-fluid">
				...
				<ul id="list1" class="nav navbar-nav">
					...
					<li class="active"><a href="upload.html">More</a></li>
					<li class="active"><a href="student_edit.php">Edit</a></li>
		...
		<div class=" container-fluid" id="dash">
		  <div class="row">
		    <div class="well col-sm-4" style="background-color: #AED4F1 ; height:auto; margin:10px;">
			 ...
			 <img class="img-responsive " src="Images/logo.jpg" height="120px" width="120px" align="center" style="border-radius:50%"></img> 
			  <br>
			  <br>
			  		<?php
