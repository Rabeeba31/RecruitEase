<html>
       ...
       <input type=\"submit\"></input>
        ...
        "</form>";
             ...
             if ($result->num_rows > 0) {
                 ...
                 echo "<table class=\"table table-hover\"><tr><th>Name</th><th>Email</th><th>Contact No.</th><th>D.O.B</th><th>Degree</th><th>Branch</th><th>Year of Passing</th><th>CGPA</th><th>12th Percentage</th><th>10th Percentage</th><th>Backlog</th></tr>";
 ...
 <script>
    function filterTable() {
        var cgpaFilterValue = parseFloat(document.getElementById('cgpaFilter').value);
        var backlogFilterValue = parseInt(document.getElementById('backlogFilter').value);
        var tableRows = document.getElementsByTagName('tr');

        for (var i = 1; i < tableRows.length; i++) {
            var row = tableRows[i];
            var cgpa = parseFloat(row.getElementsByTagName('td')[7].innerText);
            var backlog = parseInt(row.getElementsByTagName('td')[10].innerText);

            if ((isNaN(cgpaFilterValue) || cgpa == cgpaFilterValue) && (isNaN(backlogFilterValue) || backlog == backlogFilterValue)) {
                row.style.display = '';
            } else {
